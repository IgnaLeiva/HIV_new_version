...
```{r}
library(tableone)
tabweighted<- svyCreateTableOne(vars=c("VL.dectable", "adherent", variables), strata="employed", data=dta.survey, test=FALSE)

#show table with SMD and pairwise SMD
tblone <- print(tabweighted, smd=TRUE)
as.data.frame(tblone)  |> gt(rownames_to_stub = T) |> tab_caption(caption = md("Baseline characteristics of weighted cohort"))

tbl |>  gtsave("tab_1.docx")

>>>>>>> 93fa6d4bfdc515cd0fc31bd87e6b48c50f5764f8
